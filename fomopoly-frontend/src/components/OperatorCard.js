        ...
        return (
            <div className='operator-card'>
                ...
                <div className='trader-card-button'>
                    <p style={{marginBottom: '2px', marginTop: '2px'}}>{`${this.props.user.name}`}</p>
                </div>
                <hr className='prop-divider'/>
                <div className='trader-card-button'>
                    <p style={{marginBottom: '2px', marginTop: '2px'}}>{`-OFFERING-`}</p>
                </div>
                <div style={{height: '134px'}}>
                    {this.renderOfferOverview(this.props.offerings)}
                </div>
            </div>
        )
    }
